...
def update_weights(
    ...
    *,
    ...
    if num_updates_list is not None:
        update_info["num_updates_list"] = num_updates_list
...
def init_trainer_group(base_url: str):
    ...
    print(
        "Initializing weight transfer: "
        f"master={master_address}:{master_port}, world_size={world_size}"
    )
